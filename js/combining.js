    ...
    var e = $(window).width(),
        t = function(e) {
            ...
            jQuery(".navbar-nav-scroll > li").each(function() {
                ...
                r.offset().top - n - 20 <= t && r.offset().top + r.height() > t ? (jQuery(".navbar-nav-scroll a").parent("li").removeClass("active"), e.parent("li").addClass("active")) : e.parent("li").removeClass("active")
            })
        },
        r = function() {
            $(".header").css("height", "");
    ...
    return {
        init: function() {
            jQuery(".box-hover").on("mouseenter", function() {
                ...
                function(e) {
                ...
                }(u), $(".content-scroll").length && $(".content-scroll").mCustomScrollbar({
                    setWidth: !1,
                    setHeight: !1,
                    axis: "y"
                    ...
                    jQuery(".modal:visible").each(l), jQuery(".equal-wraper").length && i(".equal-wraper .equal-col"), a()
                ...
                function() {
                    if ($("#smartwizard").length > 0) {
                        $("#smartwizard").on("showStep", function(e, t, r, n, i) {
                            "first" === i ? $("#prev-btn").addClass("disabled") : "final" === i ? $("#next-btn").addClass("disabled") : ($("#prev-btn").removeClass("disabled"), $("#next-btn").removeClass("disabled"))
                        });
                ...
                }(), jQuery(".deznav-scroll").length > 0 && (new PerfectScrollbar(".deznav-scroll").isRtl = !1), $("#datetimepicker").length > 0 && $("#datetimepicker").datetimepicker(), jQuery(".modal").on("show.bs.modal", l)
        },
        load: function() {
            e > 1023 && jQuery(".bgeffect").length && skrollr.init({
                ...
                }), i(".equal-wraper .equal-col"), jQuery(".counter").length && jQuery(".counter").counterUp({
                    delay: 10,
                    time: 3e3
                }),
                function() {
